 ...
 * @author K15H3N
 */
public class CLASS_staff extends CLASS_users {
    
    public static int id;
    public static String name, email, phoneNumber; //static because parent constructor not yet executed
    public String role;
    
    public CLASS_staff(int id, String name, String email, String phoneNumber){
    ...
    public CLASS_staff(int id, String name, String email, String phoneNumber, int rowCount, int columnCount, int selectedRow){
        super(id, name, email, phoneNumber);
        role = "staff";
